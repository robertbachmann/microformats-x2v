...
<xsl:template name="vcard">	
	<xsl:if test="not($Anchor) or @id = $Anchor">
		<xsl:if test="count(.//*[contains(concat(' ',normalize-space(@class),' '),' vcard ')]) &gt; 0">
			<!-- Check for mandatory FN -->
			<xsl:if test="count(.//*[contains(concat(' ',normalize-space(@class),' '),' fn ')]) = 0">
				<xsl:text>No &lt;code&gt;FN&lt;/code&gt; property was found&lt;br/&gt;</xsl:text>
			</xsl:if>



			<xsl:if test="(count(.//*[contains(concat(' ',normalize-space(@class),' '),' n ')]) &gt; 0 or (.//*[contains(concat(' ',normalize-space(@class),' '),' n ')] != '')) and (.//*[contains(concat(' ',normalize-space(@class),' '),' fn ')] = .//*[contains(concat(' ',normalize-space(@class),' '),' org ')])">
				<xsl:text>&lt;code&gt;FN&lt;/code&gt; property equals &lt;code&gt;ORG&lt;/code&gt; property, therefore this is a vCard for a company, So &lt;code&gt;N&lt;/code&gt; must be omitted&lt;br/&gt;</xsl:text>
			</xsl:if>

			<!-- Check for bad N optimization -->
			<xsl:if test="count(.//*[contains(concat(' ',normalize-space(@class),' '),' n ')]) = 0 and (.//*[contains(concat(' ',normalize-space(@class),' '),' fn ')] != .//*[contains(concat(' ',normalize-space(@class),' '),' org ')])">
				<xsl:if test="count(.//*[contains(concat(' ',normalize-space(@class),' '),' n ')]) = 0">
					<xsl:text>There is no &lt;code&gt;N&lt;/code&gt; field, AND the &lt;code&gt;FN&lt;/code&gt; does NOT exist&lt;br/&gt;</xsl:text>
				</xsl:if>
			</xsl:if>
	
			<!-- Checks that email is ONLY mailto: -->
			<xsl:for-each select=".//*[contains(concat(' ',normalize-space(@class),' '),' email ')]">
				<xsl:if test="@href and not(starts-with(@href, 'mailto:'))">
					<xsl:text>&lt;code&gt;email&lt;/code&gt; property must be a mailto value&lt;br/&gt;</xsl:text>
				</xsl:if>
			</xsl:for-each>
			...
			<!-- Check for Capitals in additional-name -->
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' additional-names ')]">
				<xsl:text>&lt;code&gt;additional-names&lt;/code&gt; property should be represented as &lt;code&gt;additional-name&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Additional-Names ')]">
				<xsl:text>&lt;code&gt;Additional-Names&lt;/code&gt; property should be represented as &lt;code&gt;additional-name&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			...
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Additional-Name ')]">
				<xsl:text>&lt;code&gt;Additional-Name&lt;/code&gt; property should be represented as &lt;code&gt;additional-name&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Additional-name ')]">
				<xsl:text>&lt;code&gt;Additional-name&lt;/code&gt; property should be represented as &lt;code&gt;additional-name&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			
			<!-- Check for Capitals in honorific-prefix -->
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' honorific-prefixes ')]">
				<xsl:text>&lt;code&gt;honorific-prefixes&lt;/code&gt; property should be represented as &lt;code&gt;honorific-prefix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-Prefixes ')]">
				<xsl:text>&lt;code&gt;Honorific-Prefixes&lt;/code&gt; property should be represented as &lt;code&gt;honorific-prefix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			...
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-Prefix ')]">
				<xsl:text>&lt;code&gt;Honorific-Prefix&lt;/code&gt; property should be represented as &lt;code&gt;honorific-prefix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-prefix ')]">
				<xsl:text>&lt;code&gt;Honorific-prefix&lt;/code&gt; property should be represented as &lt;code&gt;honorific-prefix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
	
			<!-- Check for Capitals in honorific-suffix -->
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' honorific-suffixes ')]">
				<xsl:text>&lt;code&gt;honorific-suffixes&lt;/code&gt; property should be represented as &lt;code&gt;honorific-suffix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-Suffixes ')]">
				<xsl:text>&lt;code&gt;Honorific-Suffixes&lt;/code&gt; property should be represented as &lt;code&gt;honorific-suffix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			...
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-Suffix ')]">
				<xsl:text>&lt;code&gt;Honorific-Suffix&lt;/code&gt; property should be represented as &lt;code&gt;honorific-suffix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Honorific-suffix ')]">
				<xsl:text>&lt;code&gt;Honorific-suffix&lt;/code&gt; property should be represented as &lt;code&gt;honorific-suffix&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			
			<!-- Check for Capitals in nickname -->
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' nicknames ')]">
				<xsl:text>&lt;code&gt;nicknames&lt;/code&gt; property should be represented as &lt;code&gt;nickname&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Nicknames ')]">
				<xsl:text>&lt;code&gt;Nicknames&lt;/code&gt; property should be represented as &lt;code&gt;nickname&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>
			<xsl:if test=".//*[contains(concat(' ',normalize-space(@class),' '),' Nickname ')]">
				<xsl:text>&lt;code&gt;Nickname&lt;/code&gt; property should be represented as &lt;code&gt;nickname&lt;/code&gt;&lt;br/&gt;</xsl:text>
			</xsl:if>

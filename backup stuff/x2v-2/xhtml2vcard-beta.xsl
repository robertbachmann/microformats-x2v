...
This work is licensed under a new license that has yet to be determined! It will be one of the many OSI license.
...
<xsl:param name="Prodid" select='"-//suda.co.uk//X2V 0.6.21 (BETA)//EN"' />

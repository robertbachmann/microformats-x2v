...
<code>http://suda.co.uk/projects/X2V/get-vcal.php?uri=&lt;COMPLETE-URL-TO-YOUR-SITE&gt;</code></p>
		...
		<p class="notice">Due to problems, an additional optional parameter has been added. You can now pass &amp;e=&lt;encoding type&gt;, such as UTF-8. The default is UTF-16, this is to correct problems with the Apple Address Book being unable to import vCards encoded in UTF-8. Some Older windows users will need to use the UTF-8 link, even older users will just get non-sense because the importing applications do NOT support UTF-8.</p>
		...
		<a href="javascript:location.href='http://suda.co.uk/projects/X2V/get-vcard.php?uri='+escape(location.href)">Extract <abbr title="Virtual Card">vCard</abbr> data</a> (Drag UTF-16 link to the Bookmarks Bar)<br/>
		<a href="javascript:location.href='http://suda.co.uk/projects/X2V/get-vcard.php?e=UTF-8&amp;uri='+escape(location.href)">Extract <abbr title="Virtual Card">vCard</abbr> data</a> (Drag UTF-8 link to the Bookmarks Bar)
		</p>
				<p>The <abbr title="XML Stylesheet Language Transformation" class="initialism">XSLT</abbr> file used to transform the data is available at:</p>
		<ul>
